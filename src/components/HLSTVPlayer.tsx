  ...
  return (
    ...
    >
      <div className="relative aspect-video bg-black">
        ...
        {isPlaying && (
          <>
            <div className="absolute top-0 left-0 w-28 h-14 bg-gradient-to-br from-black via-black/95 to-transparent z-10" />
            <div className="absolute top-0 right-0 w-32 h-18 bg-gradient-to-bl from-black via-black/85 to-transparent z-10" />
